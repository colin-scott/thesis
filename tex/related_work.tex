...
% the middle of the trace.
%
\noindent{\textbf{Thread Schedule Minimization Augmented with Program Analysis.}} One can remove events in the middle of the deterministic
...
interpose (in part) at the application layer (similar to \sys). As we discussed in \S\ref{subsec:generality}, interposing
at the application layer has several advantages over interposing at a lower
layer, while syscall level interposition is more broadly applicable.
