...
\noindent{\bf Reproducing Sequence Size.} We compare the size of the
...
\noindent{\bf Minimization Pace.} To measure how quickly \sys~makes
...
\noindent{\bf Qualitative Metrics.} We do not evaluate how minimization helps
...
\noindent{\bf External message shrinking.} We demonstrate the benefits of
...
\noindent{\bf Instrumentation Overhead.} Table~\ref{tab:instrumentation} shows
