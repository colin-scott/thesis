...
answer to the minimization function. Since we only consider safety violations
...
\subsection{Properties useful for minimizing external events}
...
% Earlier idea: interposing at a library layer, e.g. the NIB.
